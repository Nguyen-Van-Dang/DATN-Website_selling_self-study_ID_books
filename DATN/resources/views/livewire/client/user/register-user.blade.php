<div>
    <form wire:submit.prevent="handleRegister" class="sign-up-form" style="position: relative">
        ...
        <div class="social-media">
            ...
            <a href="{{ route('login-by-zalo') }}" class="social-icon">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="30px"
                    viewBox="0 0 50 50">
                    <path
            ...
            <a href="{{ route('login-by-google') }}" title="Google" class="social-icon">
