                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nhập tên sách..."
                                    wire:model="bookName" name="bookName" value="{{ $this->bookName }}">
                                @error('bookName')
                            ...
                            <div class="row">
                                        ...
                                        <select class="form-control" wire:model="bookAuthor" name="bookAuthor">
                                            ...
                                            @foreach ($teachers as $teacher)
                                                <option value="{{ $teacher->id }}"
                                                    {{ $teacher->id == $this->bookAuthor ? 'selected' : '' }}>
                                                    {{ $teacher->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label>Sách pdf: (<a href="{{ $this->bookFile }}" target="_blank">Xem file trước
                                                đó</a>)</label>
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="custom-file" style="display: contents">
                                            @if ($bookImage && is_string($bookImage))
                                                <img id="image-placeholder" src="{{ $bookImage }}"
                                    ...
                                    <div class="col-8">
                                        <div class="custom-file" style="display:contents">
                                            @for ($i = 0; $i < 4; $i++)
                                                <div class="custom-file" style="display: contents">
                                                    @if ($imageGallery[$i] && is_string($imageGallery[$i]))
                                                        <img id="image-placeholder-{{ $i }}"
                                                            src="{{ $imageGallery[$i] }}" alt="Click to choose image"
                                                            class="img-thumbnail p-0 m-1"
                                                            style="cursor: pointer; width: 100%; max-width: 100px;">
                                                    @elseif($imageGallery[$i])
                                                        <img id="image-placeholder-{{ $i }}"
