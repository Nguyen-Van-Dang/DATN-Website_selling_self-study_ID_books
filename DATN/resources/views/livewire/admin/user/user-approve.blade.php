        ...
        <tr>
            ...
            <td>
                <div class="flex align-items-center list-user-action">
                    <!-- Duyệt -->
                    <form action="{{ route('model.approve', ['model' => 'user', 'id' => $user->id]) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('PATCH')
                    ...
                    <!-- Từ chối (Xóa) -->
                    <form action="{{ route('model.reject', ['model' => 'user', 'id' => $user->id]) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
