                   ...
                   <table class="data-tables table table-striped table-bordered" style="width:100%">
                     <thead>
                         <tr>
                             ...
                             <th style="width: 15%;">Thể loại khóa học</th>
                             <th style="width: 15%;">Tác giả khóa học</th>
                     ...
                     <tbody>
                         <tr>
                             ...
                             <td>Jhone Steben</td>
                             <td>
                               <p class="mb-0">Cuốn khóa học đầu tiên của tôi, 'Reading the World' hay 'The World between Two Covers', được biết đến ở Hoa Kỳ, được lấy cảm hứng từ cuộc hành trình kéo dài một năm của tôi thông qua một cuốn khóa học từ mọi quốc gia trên thế giới mà tôi đã ghi lại </p>
                             </td>
                             <td>$89</td>
                             ...
                             <td>
                                <div class="flex align-items-center list-user-action">
                                  ...
                                  <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{route('updateCourse')}}"><i class="ri-pencil-line"></i></a>
