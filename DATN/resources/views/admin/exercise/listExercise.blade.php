                   ...
                   <table class="data-tables table table-striped table-bordered" style="width:100%">
                     ...
                     <tbody>
                         <tr>
                             ...
                             <td>General Books</td>
                             <td>Jhone Steben</td>
                             <td><a href="{{ asset('assets/images/book/book-pdf/hieu-ve-trai-tim.pdf')}}" target="_blank" type="application/pdf"><i class="ri-file-fill text-secondary font-size-18"></i></a></td>
                             <td>
