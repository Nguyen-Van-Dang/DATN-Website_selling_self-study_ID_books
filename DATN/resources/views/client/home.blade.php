                    ...
                    <div class="iq-card-body">
                        <div class="row align-items-center">
                            <div class="col-sm-5 pr-0">
                                <a href="javascript:void();"><img class="img-fluid rounded w-100"
                                        src="{{ asset('assets/images/book/book/18.jpg') }}" alt=""></a>
                            </div>
                        ...
                        <ul id="favorites-slider" class="list-inline p-0 mb-0 row">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="col-5 p-0 position-relative">
                                        <a href="javascript:void();">
                                            <img src="{{ asset('assets/images/book/book/55.jpg') }}"
                            ...
                            <li class="col-md-4">
                                <div class="d-flex align-items-center">
                                    <div class="col-5 p-0 position-relative">
                                        <a href="javascript:void();">
                                            <img src="{{ asset('assets/images/book/book/25.jpg') }}"
                                                class="img-fluid rounded w-100" alt="">
                                        </a>
                                    </div>
                                    <div class="col-7">
                            ...
                            <li class="col-md-4">
                                <div class="d-flex align-items-center">
                                    <div class="col-5 p-0 position-relative">
                                        <a href="javascript:void();">
                                            <img src="{{ asset('assets/images/book/book/02.jpg') }}"
                                                class="img-fluid rounded w-100" alt="">
                                        </a>
                                    </div>
                                    <div class="col-7">
