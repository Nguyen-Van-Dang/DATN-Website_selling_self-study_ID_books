                                        ...
                                        <div class="row align-items-center">
                                                ...
                                                <ul id="description-slider-nav"
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0);">
                                                            <img src="{{ asset('assets/images/book-dec/01.jpg') }}"
                                                                class="img-fluid rounded w-100" alt="">
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);">
                                                            <img src="{{ asset('assets/images/book-dec/02.jpg') }}"
                                                                class="img-fluid rounded w-100" alt="">
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);">
                                                            <img src="{{ asset('assets/images/book-dec/03.jpg') }}"
                                                                class="img-fluid rounded w-100" alt="">
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);">
                                                            <img src="{{ asset('assets/images/book-dec/04.jpg') }}"
                                                                class="img-fluid rounded w-100" alt="">
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);">
                                                            <img src="{{ asset('assets/images/book-dec/05.jpg') }}"
                                                                class="img-fluid rounded w-100" alt="">
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);">
                                                            <img src="{{ asset('assets/images/book-dec/06.jpg') }}"
                                                                class="img-fluid rounded w-100" alt="">
                                                        </a>
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="col-9">
                                                <ul id="description-slider"
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0);">
                                                            <img src="{{ asset('assets/images/new_realeases/img01.jpg') }}"
                                ...
                                <div class="iq-card-transparent iq-card-block iq-card-stretch iq-card-height">
                                    <div class="iq-card-body p-0">
                                        ...
                                        <div class="price d-flex align-items-center font-weight-500">
                                            <span
                                                class="font-size-20 pr-2 old-price">{{ number_format($Book->price, 0, ',', '.') }}đ</span>
                                            <span
                                    ...
                                    <div class="col-5">
                                        <div class="position-relative image-overlap-shadow">
                                            <a href="javascript:void();"><img class="img-fluid rounded w-100"
                                                    src="{{ asset('assets/images/similar-books/01.jpg') }}"
                                                    alt=""></a>
                                            <div class="view-book">
                            ...
                            <li class="col-md-3">
                                <div class="row align-items-center">
                                    <div class="col-5">
                                        <div class="position-relative image-overlap-shadow">
                                            <a href="javascript:void();"><img class="img-fluid rounded w-100"
                                                    src="{{ asset('assets/images/similar-books/02.jpg') }}"
                                                    alt=""></a>
                                            <div class="view-book">
                            ...
                            <li class="col-md-3">
                                <div class="row align-items-center">
                                    <div class="col-5">
                                        <div class="position-relative image-overlap-shadow">
                                            <a href="javascript:void();"><img class="img-fluid rounded w-100"
                                                    src="{{ asset('assets/images/similar-books/03.jpg') }}"
                                                    alt=""></a>
                                            <div class="view-book">
                                                <a href="book-page.html" class="btn btn-sm btn-white">Xem sách</a>
                                            </div>
                            ...
                            <li class="col-md-3">
                                <div class="row align-items-center">
                                    <div class="col-5">
                                        <div class="position-relative image-overlap-shadow">
                                            <a href="javascript:void();"><img class="img-fluid rounded w-100"
                                                    src="{{ asset('assets/images/similar-books/04.jpg') }}"
                                                    alt=""></a>
                                            <div class="view-book">
                                                <a href="book-page.html" class="btn btn-sm btn-white">Xem sách</a>
                                            </div>
                            ...
                            <li class="col-md-3">
                                <div class="row align-items-center">
                                    <div class="col-5">
                                        <div class="position-relative image-overlap-shadow">
                                            <a href="javascript:void();"><img class="img-fluid rounded w-100"
                                                    src="{{ asset('assets/images/similar-books/05.jpg') }}"
                                                    alt=""></a>
                                            <div class="view-book">
                                                <a href="book-page.html" class="btn btn-sm btn-white">Xem sách</a>
                                            </div>
                        ...
                        <ul id="trendy-slider" class="list-inline p-0 mb-0 row">
                            <li class="col-md-3">
                                <div class="d-flex align-items-center">
                                    <div class="col-5 p-0 position-relative image-overlap-shadow">
                                        <a href="javascript:void();"><img class="img-fluid rounded w-100"
                                                src="{{ asset('assets/images/trendy-books/01.jpg') }}"
                                                alt=""></a>
                                        <div class="view-book">
                                            <a href="book-page.html" class="btn btn-sm btn-white">Xem sách</a>
                                        </div>
                            ...
                            <li class="col-md-3">
                                <div class="d-flex align-items-center">
                                    <div class="col-5 p-0 position-relative image-overlap-shadow">
                                        <a href="javascript:void();"><img class="img-fluid rounded w-100"
                                                src="{{ asset('assets/images/trendy-books/02.jpg') }}"
                                                alt=""></a>
                                        <div class="view-book">
                                            <a href="book-page.html" class="btn btn-sm btn-white">Xem sách</a>
                                        </div>
                            ...
                            <li class="col-md-3">
                                <div class="d-flex align-items-center">
                                    <div class="col-5 p-0 position-relative image-overlap-shadow">
                                        <a href="javascript:void();"><img class="img-fluid rounded w-100"
                                                src="{{ asset('assets/images/trendy-books/03.jpg') }}"
                                                alt=""></a>
                                        <div class="view-book">
                                            <a href="book-page.html" class="btn btn-sm btn-white">Xem sách</a>
                                        </div>
                            ...
                            <li class="col-md-3">
                                <div class="d-flex align-items-center">
                                    <div class="col-5 p-0 position-relative image-overlap-shadow">
                                        <a href="javascript:void();"><img class="img-fluid rounded w-100"
                                                src="{{ asset('assets/images/trendy-books/04.jpg') }}"
                                                alt=""></a>
                                        <div class="view-book">
                                            <a href="book-page.html" class="btn btn-sm btn-white">Xem sách</a>
                                        </div>
                            ...
                            <li class="col-md-3">
                                <div class="d-flex align-items-center">
                                    <div class="col-5 p-0 position-relative image-overlap-shadow">
                                        <a href="javascript:void();"><img class="img-fluid rounded w-100"
                                                src="{{ asset('assets/images/trendy-books/05.jpg') }}"
                                                alt=""></a>
                                        <div class="view-book">
                                            <a href="book-page.html" class="btn btn-sm btn-white">Xem sách</a>
                                        </div>
                            ...
                            <li class="col-md-3">
                                <div class="d-flex align-items-center">
                                    <div class="col-5 p-0 position-relative image-overlap-shadow">
                                        <a href="javascript:void();"><img class="img-fluid rounded w-100"
                                                src="{{ asset('assets/images/trendy-books/06.jpg') }}"
                                                alt=""></a>
                                        <div class="view-book">
                                            <a href="book-page.html" class="btn btn-sm btn-white">Xem sách</a>
                                        </div>
                        ...
                        <ul id="favorites-slider" class="list-inline p-0 mb-0 row">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="col-5 p-0 position-relative">
                                        <a href="javascript:void();">
                                            <img src="{{ asset('assets/images/favorite/01.jpg') }}"
                                                class="img-fluid rounded w-100" alt="">
                                        </a>
                                    </div>
                                    <div class="col-7">
                            ...
                            <li class="col-md-4">
                                <div class="d-flex align-items-center">
                                    <div class="col-5 p-0 position-relative">
                                        <a href="javascript:void();">
                                            <img src="{{ asset('assets/images/favorite/02.jpg') }}"
                                                class="img-fluid rounded w-100" alt="">
                                        </a>
                                    </div>
                                    <div class="col-7">
                            ...
                            <li class="col-md-4">
                                <div class="d-flex align-items-center">
                                    <div class="col-5 p-0 position-relative">
                                        <a href="javascript:void();">
                                            <img src="{{ asset('assets/images/favorite/03.jpg') }}"
                                                class="img-fluid rounded w-100" alt="">
                                        </a>
                                    </div>
                                    <div class="col-7">
                            ...
                            <li class="col-md-4">
                                <div class="d-flex align-items-center">
                                    <div class="col-5 p-0 position-relative">
                                        <a href="javascript:void();">
                                            <img src="{{ asset('assets/images/favorite/04.jpg') }}"
                                                class="img-fluid rounded w-100" alt="">
                                        </a>
                                    </div>
                                    <div class="col-7">
