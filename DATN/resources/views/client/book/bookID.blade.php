    ...
    <div class="book">
        <form action="#">
            ...
            <div class="form-group fullname">
                ...
                <input type="text" id="fullname" style="font-weight: bold; border-radius: 10px;"
                    placeholder="Điền số ID từ bìa trước sách">
            </div>
            <div class="form-group email">
                <label for="text">Mã cào kích hoạt</label>
                <input type="text" id="text" style="font-weight: bold; border-radius: 10px;"
                    placeholder="Điền mã kích hoạt từ bìa phụ sách (5 kí tự)">
            </div>
