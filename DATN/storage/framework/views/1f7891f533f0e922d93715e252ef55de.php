                                ...
                                <div class="iq-card-body p-0 ">
                                    ...
                                    <a href="#" class="iq-sub-card">
                                        <div class="media align-items-center">
                                            <div class="">
                                                <img class="avatar-40 rounded"
                                                    src="<?php echo e(asset('assets/images/book/user/4.jpg')); ?>" alt="">
                                            </div>
                                            <div class="media-body ml-3">
                                        ...
                                        <div class="forms-container">
                                            <div class="signin-signup">
                                                ...
                                                <form method="post" action="<?php echo e(route('handleLogin')); ?>"
                                                    class="sign-in-form">
                                                    <?php echo csrf_field(); ?>
                                                    <!--[if BLOCK]><![endif]--><?php if($errors->has('login')): ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                                    ...
                                                    <div class="input-field">
                                                        ...
                                                        <input type="password" name="password"
                                                            value="<?php echo e(old('password')); ?>" placeholder="Mật khẩu" />
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                                    ...
                                                    <p class="social-text" style="margin-left: 50px">Hoặc các mạng xã
                                                        hội
                                                        khác</p>
                                                    <div class="social-media">
                                                        ...
                                                        <a href="<?php echo e(route('login-by-google')); ?>" title="Google"
                                                            class="social-icon">
