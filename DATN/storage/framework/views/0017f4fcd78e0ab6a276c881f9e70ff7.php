        ...
        <div class="iq-card-body">
            <div class="table-responsive">
                <table class="data-tables table table-striped table-bordered" style="width:100%">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(sizeof($courseCate) > 0): ?>
                        <tbody class="text-center">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $courseCate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($item->id); ?></td>
                                    <td class="mb-0"><?php echo e($item->name); ?></td>
                                    <?php
                                        $user = $item->user;
                                    ?>
                                    ...
                                    <td>
                                        <div class="flex align-items-center list-user-action">
                                            ...
                                            <a class="bg-primary text-white" data-toggle="tooltip" title="Chỉnh sửa"
                                                wire:click="openPopup('edit', <?php echo e($item->id); ?>)">
            ...
            <div class="text-end">
                <?php echo e($courseCate->links()); ?>

            </div>
        </div>
    </div>
    <!-- Popup thêm danh mục -->
    <div class="modal <?php echo e($isAddPopupOpen ? 'is-open' : ''); ?>" id="addCourseCateModal" wire:click="closePopup()">
                    ...
                    <div class="iq-card-body">
                        <form wire:submit.prevent="storeCourseCate">
                            <div class="form-group">
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['nameAdd'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['descriptionAdd'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <!-- Popup xóa danh mục -->
    <div class="modal <?php echo e($isDeletePopupOpen ? 'is-open' : ''); ?>" id="deletedCourseCateModal"
...
<?php /**PATH D:\DATN-Website_selling_self-study_ID_books\DATN\resources\views/livewire/admin/course-cate/course-cate-index.blade.php ENDPATH**/ ?>